...
class EditRewardPage extends StatefulWidget {
  const EditRewardPage({
    Key? key,
    required this.editRewardController,
    required this.id,
  }) : super(key: key);

  final EditRewardController editRewardController;
  final String? id;
...
class _EditRewardPageState extends State<EditRewardPage> {
  ...
  void loadReward() async {
    RewardModel reward = await widget.editRewardController
        .getReward(widget.id, FirebaseAuth.instance.currentUser!.uid);
    _titleController.text = reward.title;
    _durationController.text = reward.duration.toString();
    _rewardController.text = reward.reward.toString();
    _descriptionController.text = reward.description.toString();
    setState(() {
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (formKey.currentState!.validate()) {
                            ...
                            widget.editRewardController.editReward(
                                rewardModel,
                                widget.id,
